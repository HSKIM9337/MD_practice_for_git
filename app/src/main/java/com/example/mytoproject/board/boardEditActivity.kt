...
import com.example.mytoproject.databinding.ActivityBoardEditBinding
...
// ImageView in your Activity
    ...
    private fun editBoardData(key:String) {
        FBRef.boardRef.child(key).setValue(BoardModel(binding.titleArea.text.toString(),binding.contentsArea.text.toString(),writerUid,FBAuth.getTime()))
